			...
			<table class="table table-bordered" cellspacing="10" cellpadding="5">
				<div class="form-group">
					<tr>
						...
						<td><input class="form-control" id="data_inicial" type="text" name="data_inicial" value="<?php echo date("d/m/Y")?>"/></td>
					</tr>
				</div>		
				...
				<div class="form-group">
					<tr>
						...
						<td><input class="form-control" id="data_final" type="text" name="data_final" value="<?php echo date("d/m/Y")?>"/></td>
					</tr>
				</div>
